            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="<?php echo site_url('/adminhome')?>"
                        class="nav-link text-white d-flex align-items-center gap-2 active" aria-current="page"
                        id="dashboard">
                ...
                <li>
                    <a href="<?php echo site_url('/adminbase')?>"
                        class="nav-link text-white d-flex align-items-center gap-2" id="admin">
                ...
                <li>
                    <a href="<?php echo site_url('/admin/produk')?>"
                        class="nav-link text-white d-flex align-items-center gap-2" id="produk">

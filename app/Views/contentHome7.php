    ...
    <div class="fluid detail-container">
        <div class="grid-container">
            <div class="equalizer grid-x grid-margin-x p-y-60" data-equalizer>
                ...
                <div class="desc-imager cell medium-4 image-container main-image text-center" data-equalizer-watch>
                    <div id="carousel-1" class="carousel slide" data-ride="carousel">

                        <div class="drower carousel-indicators">
                            <img class="demo cursor active" src="SC.jpg" data-target="#carousel-1" data-slide-to="0"
                                alt="The Woods">
                            <img class="demo cursor" src="SC1.jpg" data-target="#carousel-1" data-slide-to="1"
                                alt="Cinque Terre">
                            <img class="demo cursor" src="SC2.jpg" data-target="#carousel-1" data-slide-to="2"
                                alt="Mountains and fjords">
                            <img class="demo cursor" src="SC3.jpg" data-target="#carousel-1" data-slide-to="3"
                                alt="Northern Lights">
                        </div>
                ...
                <div class="desc-details cell medium-7 text-container grid-x p-l-0 s-p-l-0" data-equalizer-watch>
                    ...
                    <div class="container deskripsi">
                        <ul class="nav nav-tabs row g-2 d-flex">
                            <li class="nav-item p-0 col-4">
                                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#tab-8">
                                    <p>Deskripsi</p>
                                </a>
                            </li>
                            <!-- End tab nav item -->
